  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Empowering Employers with a Comprehensive Solution for Employee Data, Vacation, and Payroll Management"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Empowering Employers with a Comprehensive Solution for Employee Data, Vacation, and Payroll Management`}
            </Text>
            <Box
